...
namespace HW3
{
    class Game1A2B
    {
        ...
        public string GenNumber(int n)
        {
            ...
            do
            {
                // Copy nos to a new array for shuffling
                string[] digits = (string[])nos.Clone();
                Shuffle(digits); // Use the Shuffle method
        ...
        // 回傳比較 guess 與 answer 是 幾A幾B 的結果:
            public int[] GetAB(string guess, string answer= null)
        {
        ...
        // Add public properties for numberLen and answer with get/set accessors
