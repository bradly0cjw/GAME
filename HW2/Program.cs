...
namespace HW2
{
    internal class Program
    {
        ...
        // Solution for the jagged array problem
        static void sol1()
        {
            ...
            for (int r = 0; r < rows; r++)
            {
                for (int c = 0; c < ary[r].Length; c++)
                {
                    // align numbers to width 2 to roughly match sample
                    Console.Write($"ary({r},{c})={ary[r][c],2}");
                    if (c < ary[r].Length - 1) Console.Write(" ");
                }
                Console.WriteLine();
            }
        }
